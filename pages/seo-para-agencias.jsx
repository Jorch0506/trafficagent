// pages/seo-para-agencias.jsx
// Landing SEO optimizada — SEO para Agencias

import Head from "next/head";
import { useRouter } from "next/router";

const FAQS = [{"q": "¿Puedo usar CAEVIK con marca blanca para mis clientes?", "a": "El PDF exportado incluye la marca CAEVIK actualmente. La función white label está en desarrollo para el plan Agency."}, {"q": "¿Hay descuentos para agencias con muchos clientes?", "a": "El plan Agency incluye 100 análisis al mes y 10 sitios simultáneos. Para volúmenes mayores escríbenos a hola@caevik.com."}, {"q": "¿Qué tan preciso es el análisis por nicho?", "a": "CAEVIK utiliza Claude Sonnet de Anthropic para el análisis. La precisión mejora significativamente cuando agregas la descripción del negocio del cliente."}, {"q": "¿Puedo generar un plan de prueba antes de contratar?", "a": "Sí. El plan Free permite 1 análisis completo sin tarjeta. Prueba con uno de tus clientes actuales."}];

const BENEFITS = [{"icon": "🏢", "title": "Múltiples sitios web", "desc": "El plan Agency permite analizar hasta 10 sitios simultáneamente. Un plan por cada cliente."}, {"icon": "📊", "title": "Entregables listos", "desc": "Cada análisis genera un plan completo exportable a PDF. Listo para presentar al cliente."}, {"icon": "⚡", "title": "60 segundos por cliente", "desc": "Lo que antes tardaba días de investigación, ahora toma 60 segundos por cliente."}, {"icon": "🔑", "title": "Keywords de nicho real", "desc": "CAEVIK detecta el nicho de cada cliente y genera keywords específicas de su industria."}, {"icon": "📱", "title": "Contenido para redes", "desc": "25 posts listos para cada cliente. Ahorra horas de creación de contenido mensual."}, {"icon": "💰", "title": "ROI para tus clientes", "desc": "Resultados medibles: tráfico orgánico creciente que justifica tu fee mensual ante los clientes."}];
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Herramienta SEO para Agencias de Marketing — CAEVIK</title>
        <meta name="description" content="Genera planes de tráfico orgánico para todos tus clientes en 60 segundos. La herramienta SEO que multiplica tu capacidad de entrega. Prueba gratis." />
        <meta property="og:title" content="Herramienta SEO para Agencias de Marketing — CAEVIK" />
        <meta property="og:description" content="Genera planes de tráfico orgánico para todos tus clientes en 60 segundos. La herramienta SEO que multiplica tu capacidad de entrega. Prueba gratis." />
        <meta property="og:url" content="https://www.caevik.com/seo-para-agencias" />
        <meta property="og:image" content="https://www.caevik.com/og-image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <link rel="canonical" href="https://www.caevik.com/seo-para-agencias" />
      ...
      <div style={{ background: "#03060f", color: "#e2e8f0", fontFamily: "'DM Sans', sans-serif", minHeight: "100vh" }}>
        ...
        <section style={{ maxWidth: 800, margin: "0 auto", padding: "80px 48px 60px", textAlign: "center" }}>
          <div style={{ display: "inline-block", background: "rgba(56,189,248,0.08)", border: "1px solid rgba(56,189,248,0.2)", borderRadius: 999, padding: "5px 16px", marginBottom: 28, fontSize: 12, fontWeight: 600, color: "#e879f9", letterSpacing: 1.5, textTransform: "uppercase" }}>
            SEO para Agencias
          </div>
          <h1 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "clamp(32px, 5vw, 56px)", letterSpacing: -2, lineHeight: 1.05, marginBottom: 24 }}>
            Multiplica tu capacidad de entrega con IA
          </h1>
          <p style={{ fontSize: 18, color: "#64748b", lineHeight: 1.8, marginBottom: 40, maxWidth: 600, margin: "0 auto 40px" }}>
            Genera planes de tráfico orgánico completos para cada cliente en 60 segundos. Keywords, posts, artículos SEO y directorios — todo listo para presentar.
          </p>
          <button
            onClick={() => router.push("/")}
        ...
        <section style={{ maxWidth: 1100, margin: "0 auto", padding: "0 48px 80px" }}>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 32, textAlign: "center", marginBottom: 48, letterSpacing: -1 }}>
            Todo lo que una agencia necesita para escalar
          </h2>

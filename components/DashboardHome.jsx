...
export function DashboardHome({ user, onStart, onLogout }) {
  ...
  // Leer todo desde userData — nunca usar fallback del hook
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg-base)", color: "var(--text-primary)", fontFamily: "var(--font-sans)", position: "relative", overflow: "hidden" }}>
      <GlowOrb x="-100px" y="-100px" color={loadingData ? "#38bdf8" : planColor} size={500} opacity={0.06} />

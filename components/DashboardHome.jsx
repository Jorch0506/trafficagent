...
// Recibe userData directamente desde useAuth — sin query propia
...
export function DashboardHome({ user, userData, onStart, onLogout }) {
  // Leer todo desde userData que viene del hook — ya tiene sesión establecida
  ...
  // Si userData aún no cargó, mostrar skeleton
  if (!userData) {
    return (

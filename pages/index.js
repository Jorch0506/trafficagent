    ...
    <div style={{ minHeight: "100vh", background: "#050a14", color: "#e2e8f0", fontFamily: "'DM Sans', sans-serif", overflow: "hidden", position: "relative" }}>
      ...
      <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "24px 48px", borderBottom: "1px solid #ffffff08", position: "relative", zIndex: 10, flexWrap: "wrap", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 32, height: 32, background: "linear-gradient(135deg, #38bdf8, #e879f9)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 }}>⚡</div>
          <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 20, letterSpacing: -0.5 }}>TrafficAgent</span>
        </div>
      ...
      <div style={{ width: "100%", maxWidth: 540, position: "relative", zIndex: 10 }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 16 }}>
            <div style={{ width: 36, height: 36, background: "linear-gradient(135deg, #38bdf8, #e879f9)", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>⚡</div>
            <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 22 }}>TrafficAgent</span>
          </div>
      ...
      <div style={{ background: "#0a1628", borderBottom: "1px solid #1e293b", padding: "20px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
            <div style={{ width: 28, height: 28, background: "linear-gradient(135deg, #38bdf8, #e879f9)", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14 }}>⚡</div>
            <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 18 }}>TrafficAgent</span>
          </div>
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>TrafficAgent — Genera tráfico real con IA</title>
        <meta name="description" content="Genera tráfico orgánico real a tu sitio web con inteligencia artificial. SEO automático, posts para redes sociales y directorios." />

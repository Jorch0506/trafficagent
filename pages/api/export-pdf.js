...
.sh{display:flex;align-items:center;gap:10px;margin-bottom:16px;padding-bottom:10px;border-bottom:1px solid rgba(255,255,255,0.08);page-break-after:avoid;break-after:avoid}
...
.card{background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:10px;padding:14px 16px;page-break-inside:avoid;break-inside:avoid;width:calc(50% - 5px);box-sizing:border-box}
...
<div class="cover">
  ...
  <path d="M50 0C25 0 5 20 5 45C5 70 50 120 50 120C50 120 95 70 95 45C95 20 75 0 50 0Z" fill="url(#lg1)"/>
  <path d="M50 20L65 35H35L50 20Z" fill="white" opacity="0.9"/>
  <path d="M30 48C30 48 36 42 50 42C64 42 70 48 70 48" stroke="white" stroke-width="5" stroke-linecap="round" fill="none"/>
  <path d="M36 56C36 56 42 50 50 50C58 50 64 56 64 56" stroke="white" stroke-width="5" stroke-linecap="round" fill="none"/>
  <path d="M42 64C42 64 46 60 50 60C54 60 58 64 58 64" stroke="white" stroke-width="5" stroke-linecap="round" fill="none"/>
</svg>
